...
<section class="posts">
    <div class="container">
        <article>
            <div class="pic"><img width="121" src="user/images/2.png" alt=""></div>
            <div class="info">
        ...
        <article>
            <div class="pic"><img width="121" src="user/images/3.png" alt=""></div>
            <div class="info">
...
<section class="news">
    <div class="container">
        <h2>Latest news</h2>
        <article>
            <div class="pic"><img src="user/images/1.png" alt=""></div>
            <div class="info">
        ...
        <article>
            <div class="pic"><img src="user/images/1_1.png" alt=""></div>
            <div class="info">
                <h4>Omnis iste natus error sit voluptatem accusantium </h4>
                <p class="date">14 APR 2014, Jason Bang</p>
                <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores (...)</p>
...
<script>window.jQuery || document.write("<script src='user/js/jquery-1.11.1.min.js'>\x3C/script>")</script>
